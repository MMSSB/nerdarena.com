...
//                 window.location.href = "home.html"; // Send them home after deletion
//             }
//         });
//     });
// }
...
//                 if(window.location.pathname.includes('post.html')) window.location.href = "home.html";
//             }
//             return;
//         }
//     });
...
//                     timestamp: new Date().toISOString()
//                 });
//                 window.location.href = 'home.html'; // Send back to feed after posting
//             } catch (error) { 
//                 console.error(error); 
//             } finally { 
//                 btnPost.disabled = false; 
